...
sem_t sem_cadeiras; //declaração de semaforos

sem_t sem_cad_barbeiro;//declaração de semaforos
...
int main(){
  ...
  srand((unsigned)time(NULL)); // setando a função rand() para gerar numeros aleatorios de tempo de atendimento
